...
// Helper function to inject CSS that disables text selection and hides scrollbars.
function applyGlobalCss(view) {
  ...
  const doInject = () => {
    view.webContents.insertCSS(css.trim()).catch(err => console.error(`Failed to inject global CSS:`, err));
  };
