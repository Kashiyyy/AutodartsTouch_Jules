...
// Injected immediately as the preload script runs.
...
`;
// Appending to documentElement (<html>) is safer than document.head as head may not exist when this script runs.
